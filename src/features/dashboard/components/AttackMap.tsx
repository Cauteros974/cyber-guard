  ...
  return (
    <div className="chart-card map-card">
      ...
      <div style={{ position: 'absolute', bottom: '16px', left: '24px', display: 'flex', gap: '16px', fontSize: '12px', color: 'var(--custom-prop)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', height: 30 }}><span style={{ width: 8, height: 8, borderRadius: '50%', background: 'var(--critical)' }}></span> Critical Vector</div>
